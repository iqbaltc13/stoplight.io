...
class KodeOtpAktivasiAkunBackup extends Notification
{
    use Queueable;
    ...
    {
        $message = '[ArofahMina] '.$otpCode.'. Jangan memberikan kode ini kepada siapapun, meskipun yang mengatasnamakan ArofahMina.';
