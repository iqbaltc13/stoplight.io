    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body" >
                ...
                @endif
                <form method="POST" id="form_advanced_validation" class="form-create-pekerjaan" action="{{route('dashboard.master.pekerjaan.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.master.pekerjaan.form_create')
