    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
                ...
                <div id="confirm-delete" data-uk-modal>
                    <div class="uk-modal-dialog">
                        <div class="uk-modal-header">
                            <h2 class="uk-modal-title">Confirm Delete Inspirasi Bacaan</h2>
                        </div>
            ...
            <div class="uk-card-body">
                    <form method="POST" id="form_advanced_validation" class="form-update-inspirasi-bacaan" action="{{route('dashboard.inspirasi.bacaan.update',['id'=>$data->id])}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.inspirasi.bacaan.form_edit')
