<div class="uk-card-content">
    ...
    <div class="uk-margin">
        <input class="uk-input" id="subtitle" name="subtitle" type="text" data-sc-input="outline" required>
    </div>
    <div class="uk-margin">
    ...
    <div class="uk-margin">
        ...
        <input  class="uk-input" id="duration_second" name="duration_second" type="number" data-sc-input="outline" required>
    </div>
    ...
    <div class="uk-margin">
        <label class="uk-form-label" for="f-empl-recent">Audio Url (format .mp3 & stereo)</label>
        
    </div>
    <div class="uk-margin">
       
        <input class="uk-input" id="audio_url" name="audio_url"  type="text" data-sc-input="outline" required>
    </div>
