    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
                ...
                <div class="uk-flex uk-flex-middle">
                    <div class="uk-flex-1 uk-first-column">
                        <h3 class="uk-card-title">
                            <span data-uk-icon="icon:home;ratio:1.4" class="uk-margin-medium-right"></span> Edit Artikel
                        </h3>
                    </div>
                    <div class="uk-width-auto@s" >
                        <div id="sc-dt-buttons">
                            <div class="dt-buttons">
                                <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.artikel.index')}}" ><span data-uk-icon="icon: menu"></span> <span>List Artikel</span></a>
            ...
            <div class="uk-card-body" >
                ...
                @endif
                <form method="POST" id="form_advanced_validation" class="form-edit-pekerjaan" action="{{route('dashboard.artikel.update',['id'=>$data->id])}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <input type="hidden" name="_method" value="put" />
                    @include('dashboard.artikel.form_edit')
...
@push('scripts')
<script src="https://cdn.tiny.cloud/1/qg2rcwt39crkr3ayz1qgft7ts5832g14in88o44m6v23fnsh/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
