	...
	<nav class="uk-navbar uk-navbar-container" data-uk-navbar="mode: click; duration: 360">
		<div class="uk-navbar-left nav-overlay-small uk-margin-right uk-navbar-aside">
			...
			<div class="sc-brand uk-visible@s">
				<a href="https://scutum-html.tzdthemes.com/dashboard-v1.html"><img src="{{$publicUrl}}assets/img/logo.png" alt=""></a>
			</div>
		</div>
				...
				<li>
					...
					<div class="uk-navbar-dropdown sc-padding-medium">
						<div class="uk-child-width-1-2 uk-child-width-1-3@s uk-grid uk-grid-small" data-uk-grid>
							<div>
								<a href="https://scutum-html.tzdthemes.com/pages-mailbox.html" class="uk-flex uk-flex-column uk-flex-middle uk-box-shadow-hover-small sc-round sc-padding-small">
							...
							<div>
								<a href="https://scutum-html.tzdthemes.com/pages-poi_listing.html" class="uk-flex uk-flex-column uk-flex-middle uk-box-shadow-hover-small sc-round sc-padding-small">
									<i class="mdi mdi-map-marker sc-icon-32 sc-text-lh-1 md-color-red-700"></i>
									<span class="uk-text-medium sc-color-primary">POI</span>
								</a>
							</div>
							<div>
								<a href="https://scutum-html.tzdthemes.com/pages-chat.html" class="uk-flex uk-flex-column uk-flex-middle uk-box-shadow-hover-small sc-round sc-padding-small">
							...
							<div>
								<a href="https://scutum-html.tzdthemes.com/plugins-calendar.html" class="uk-flex uk-flex-column uk-flex-middle uk-box-shadow-hover-small sc-round sc-padding-small">
							...
							<div>
								<a href="https://scutum-html.tzdthemes.com/pages-user_profile.html" class="uk-flex uk-flex-column uk-flex-middle uk-box-shadow-hover-small sc-round sc-padding-small">
							...
							<div>
								<a href="https://scutum-html.tzdthemes.com/plugins-charts.html" class="uk-flex uk-flex-column uk-flex-middle uk-box-shadow-hover-small sc-round sc-padding-small">
					...
					<div class="uk-navbar-dropdown sc-padding-remove">
						<div class="uk-panel uk-panel-scrollable uk-height-medium">
							<ul class="uk-list uk-list-divider sc-js-edge-fix">
								...
								<li class="sc-list-group">
									<div class="sc-list-addon">
										<img src="{{$publicUrl}}assets/img/avatars/avatar_06_sm.png" class="sc-avatar " alt="roob.margarett"/>
									</div>
									<a href="#" class="sc-list-body uk-display-block">
								...
								<li class="sc-list-group">
									<div class="sc-list-addon">
										<img src="{{$publicUrl}}assets/img/avatars/avatar_02_sm.png" class="sc-avatar " alt="frankie.lockman"/>
									</div>
									<a href="#" class="sc-list-body uk-display-block">
						...
						<a href="https://scutum-html.tzdthemes.com/pages-mailbox.html" class="uk-flex uk-text-small sc-padding-small-ends sc-padding-medium">Show all in mailbox</a>
					</div>
				</li>
				<li class="uk-visible@s">
					<a href="#">
	                        ...
	                        <li>
	                                ...
	                                <a href="https://scutum-html.tzdthemes.com/forms-validation.html">		                                		                                Validation	                                </a>
	                                    ...
	                                    <a href="#">Form Examples</a>	                                    <ul>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-advertising_evaluation_form.html">		                                            		                                            Advertising Evaluation Form	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-booking_form.html">		                                            		                                            Booking Form	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-car_rental_form.html">		                                            		                                            Car Rental Form	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            ...
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-contact_forms.html">		                                            		                                            Contact Forms	                                            </a>
	                                    	                                        ...
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-job_application_form.html">		                                            		                                            Job Application Form	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-medical_history_form.html">		                                            		                                            Medical History Form	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-registration_form.html">		                                            		                                            Registration Form	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-rental_application_form.html">		                                            		                                            Rental Application Form	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_examples-transaction_feedback_form.html">		                                            		                                            Transaction Feedback Form	                                            </a>
	                                        </li>
	                                    ...
	                                    <a href="#">Wizard</a>	                                    <ul>
	                                            ...
	                                            <a href="https://scutum-html.tzdthemes.com/forms_wizard-horizontal.html">		                                            		                                            Horizontal	                                            </a>
	                                    	                                        ...
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_wizard-horizontal_minimal.html">		                                            		                                            Horizontal Minimal	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_wizard-vertical.html">		                                            		                                            Vertical	                                            </a>
	                                        </li>
	                                    	                                        <li>
	                                            <a href="https://scutum-html.tzdthemes.com/forms_wizard-vertical_minimal.html">		                                            		                                            Vertical Minimal	                                            </a>
	                                        </li>
	                ...
	                <a href="#">
	                    ...
	                    <ul class="sc-sidebar-menu-sub">
	                        ...
	                        <li>
	                                ...
	                                <a href="https://scutum-html.tzdthemes.com/components-breadcrumb.html">		                                			                                <span class="uk-label">new</span>
		                                		                                Breadcrumb	                                </a>
	                        ...
	                        <li>
	                                ...
	                                <a href="https://scutum-html.tzdthemes.com/components-pagination.html">		                                			                                <span class="uk-label">new</span>
		                                		                                Pagination	                                </a>
	                ...
	                <a href="#">
	                    ...
	                    <ul class="sc-sidebar-menu-sub">
	                        ...
	                        <li>
	                                ...
	                                <a href="https://scutum-html.tzdthemes.com/pages-blank_header_expanded.html">		                                		                                Blank (expanded header)	                                </a>
