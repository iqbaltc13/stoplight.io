...
<div class="uk-card uk-margin" id="vue_component">
    ...
    <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
        <div class="uk-flex-1 uk-first-column">
            <h3 class="uk-card-title">&nbsp;&nbsp;&nbsp;List Master Pendidikan </h3>
        </div>
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.master.pendidikan.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Tambah Master Pendidikan</span></a>
    ...
    <div class="uk-card-body">
        ...
        <div id="modal-detail" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Detail Master Pendidikan</h2>
                </div>
        ...
        <div id="confirm-delete" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Confirm Delete Master Pendidikan</h2>
                </div>
...
<script>
    ...
    function modalDetail(id){
            let linkDetail = "{{route('dashboard.master.pendidikan.detail-json', ':id')}}";
    ...
    function datatableWithParse(arrParse,message){
        var url = "{{route('dashboard.master.pendidikan.datatable')}}";
        url = url + '?';
        ...
        var table = $('.datatable').DataTable({
            ...
            "columns": [
                    ...
                    { 
                        ...
                        searchable: false,
                        render: function(data){
                            let linkEdit = "{{route('dashboard.master.pendidikan.edit', ':id')}}";
    ...
    new Vue({
            ...
            methods:{
                ...
                deleteShow:function(id){
                    let linkDelete = "{{route('dashboard.master.pendidikan.destroy', ':id')}}";
                ...
                deleteSubmit:function(){
                    ...
                    let route  =  "{{route('dashboard.master.pendidikan.destroy', ':id')}}";
