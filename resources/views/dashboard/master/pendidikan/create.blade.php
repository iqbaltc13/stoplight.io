    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body" >
                ...
                @endif
                <form method="POST" id="form_advanced_validation" class="form-create-pendidikan" action="{{route('dashboard.master.pendidikan.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.master.pendidikan.form_create')
