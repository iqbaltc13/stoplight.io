    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
                    ...
                    <div class="uk-width-auto@s" style="padding-left:350px;">
                        <div id="sc-dt-buttons">
                            <div class="dt-buttons">
                                <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.master.pendidikan.index')}}" ><span data-uk-icon="icon: menu"></span> <span>List Master Pendidikan</span></a>
            ...
            <div class="uk-card-body" >
                ...
                @endif
                <form method="POST" id="form_advanced_validation" class="form-edit-pendidikan" action="{{route('dashboard.master.pendidikan.update',['id'=>$data->id])}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <input type="hidden" name="_method" value="put" />
                    @include('dashboard.master.pendidikan.form_edit')
