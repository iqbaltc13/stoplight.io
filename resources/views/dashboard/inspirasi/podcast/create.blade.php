    ...
    <div class="uk-width-4-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body">
                ...
                <form method="POST" id="form_advanced_validation" class="form-create-inspirasi-podcast" action="{{route('dashboard.inspirasi.podcast.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.inspirasi.podcast.form_create')
