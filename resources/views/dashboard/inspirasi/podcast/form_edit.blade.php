<div class="uk-card-content">
    ...
    <div class="uk-margin">
        <input class="uk-input" id="description" name="description" value="{{$data->description}}" type="text" data-sc-input="outline" required>
    </div>
    <div class="uk-margin">
    ...
    <div class="uk-margin">
        ...
        <input class="uk-input" id="audio_url" name="audio_url" value="{{$data->audio_url}}"  type="text" data-sc-input="outline" required>
    </div>
