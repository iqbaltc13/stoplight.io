...
<div class="uk-card uk-margin" >
    <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
        <div class="uk-flex-1 uk-first-column">
            <h3 class="uk-card-title">&nbsp;&nbsp;&nbsp;List Video</h3>
        </div>
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.inspirasi.video.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Add Video</span></a>
    ...
    <div class="uk-card-body">
        ...
        <div id="modal-detail" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Detail Video</h2>
                </div>
                <div class="uk-modal-body detail-video">
                    <table id="detail-video-table" class="uk-table uk-table-striped dt-responsive">
                        <tbody>
                            {{-- 
                            <tr>
                                <td></td>
        ...
        <div id="confirm-delete" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Confirm Delete Video</h2>
                </div>
                <div class="uk-modal-body delete-video">
...
<script>
    ...
    function datatableWithParse(arrParse){
        var url = "{{route('dashboard.inspirasi.video.datatable')}}";
        url = url + '?';
    ...
    function modalDetail(id){
        let linkDetail = "{{route('dashboard.inspirasi.video.detail-json', ':id')}}";
    ...
    function modalDelete(id){
        let linkDelete = "{{route('dashboard.inspirasi.video.destroy', ':id')}}";
        ...
        var table = $('.datatable').DataTable({
            ...
            "columns": [
                    ...
                    
                    {
                        ...
                        searchable: false,
                        render: function(data){
                            let linkEdit = "{{route('dashboard.inspirasi.video.edit', ':id')}}";
