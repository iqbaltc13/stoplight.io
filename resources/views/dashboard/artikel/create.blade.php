    ...
    <div class="uk-width-1@l">
        <div class="uk-card">
                ...
                <div class="uk-flex uk-flex-middle">
                    <div class="uk-flex-1 uk-first-column">
                        <h3 class="uk-card-title">
                            <span data-uk-icon="icon:home;ratio:1.4" class="uk-margin-medium-right"></span> Buat Artikel
                        </h3>
                    </div>
            ...
            <div class="uk-card-body" >
                ...
                @endif
                <form method="POST" id="form_advanced_validation" class="form-create-pekerjaan" action="{{route('dashboard.artikel.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.artikel.form_create')
