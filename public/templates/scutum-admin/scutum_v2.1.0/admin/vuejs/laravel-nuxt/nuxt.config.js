...
let dist = 'public'; // redundant in laravel-nuxt
	...
	*/
	head: {
		...
		link: [
			...
			{ rel: 'preload', href: (process.env.NODE_ENV !== 'production' ? '' : '/' + dist) + '/fonts/mdi_base64.css', as: 'style' },
			...
			{ rel: 'stylesheet', href: (process.env.NODE_ENV !== 'production' ? '' : '/' + dist) + '/fonts/mdi_base64.css' }
		]
	},
	/*
