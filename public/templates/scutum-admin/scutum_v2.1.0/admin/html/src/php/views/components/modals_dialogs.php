						...
						<div id="modal-default" data-uk-modal>
							<div class="uk-modal-dialog uk-modal-body">
								...
								<p class="uk-text-right">
									<button class="sc-button sc-button-flat uk-modal-close" type="button">Cancel</button>
				...
				<div class="uk-child-width-1-3@l uk-child-width-1-2@s uk-grid-divider" data-uk-grid>
					...
					<div>
						...
						<div id="modal-media-vimeo" class="uk-flex-top" data-uk-modal>
							<div class="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
								<button class="uk-modal-close-outside" type="button" data-uk-close></button>
								<iframe src="https://player.vimeo.com/video/289371414" width="530" height="315" data-uk-video></iframe>
							</div>
						</div>
					</div>
					<div>
